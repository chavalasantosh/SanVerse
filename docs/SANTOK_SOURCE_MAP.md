# SanTOK Source Map System

Universal knowledge source registration and tagging system for SanTOK, designed for Railway compute.

## Overview

The SanTOK Source Map system provides:
...
1. **Persistent Registry**: Source registry is saved to `data/santok_sources_registry.json`
...
See `examples/test_santok_source_map.py` for complete examples.

## API Reference

### `get_source_map(registry_file=None) -> SanTOKSourceMap`
