# SanTOK Universal File Support

## 🎯 **SanTOK Works on EVERYTHING - Not Just Text!**

**SanTOK is a UNIVERSAL tokenization system that handles ANY file type, not just text.**
...
### ✅ **ANY Other File Type**
- **SanTOK can tokenize literally ANY file on your system!**

## 🔧 How It Works

SanTOK uses a **universal file handling system** that:
...
SanTOK automatically detects and categorizes files:
...
1. **SanTOK is NOT limited to text** - It's a universal tokenization system
...
5. **No file type is excluded** - If it's a file, SanTOK can tokenize it
...
**Q: "Does SanTOK only work on text tokenization?"**

**A: NO! SanTOK is a UNIVERSAL tokenization system that works on:**
- ✅ Text files
...
SanTOK doesn't discriminate - if it's a file, it can be tokenized!
